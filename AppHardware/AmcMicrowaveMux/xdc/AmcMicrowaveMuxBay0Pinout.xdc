...
# DAC JTAG
set_property -dict {IOSTANDARD LVCMOS18 PULLUP true} [get_ports syncOutP[0][4]}]   ; # DAC TCLK
set_property -dict {IOSTANDARD LVCMOS18 PULLUP true} [get_ports syncOutP[0][3]}]   ; # DAC TRSTB
set_property -dict {IOSTANDARD LVCMOS18 PULLUP true} [get_ports syncOutP[0][5]}]   ; # DAC TDI
set_property -dict {IOSTANDARD LVCMOS18 PULLUP true} [get_ports syncOutN[0][4]}]   ; # DAC TDO
set_property -dict {IOSTANDARD LVCMOS18 PULLUP true} [get_ports syncOutN[0][3]}]   ; # DAC TMS


# DAC reset
set_property -dict {IOSTANDARD LVCMOS18 PULLUP true} [get_ports {syncOutN[0][0]}]  ; # dacReset(0)
set_property -dict {IOSTANDARD LVCMOS18 PULLUP true} [get_ports {spareN[0][9]}]    ; # dacReset(1)
...
set_property -dict { IOSTANDARD LVCMOS18 SLEW SLOW DRIVE 2 } [get_ports {spareN[0][15]}]    ; # pllSpiCsb(0)
set_property -dict { IOSTANDARD LVCMOS18 SLEW SLOW DRIVE 2 } [get_ports {spareP[0][15]}]    ; # pllSpiCsb(1)
set_property -dict { IOSTANDARD LVCMOS18 SLEW SLOW DRIVE 2 } [get_ports {spareP[0][13]}]    ; # pllSpiCsb(2)
set_property -dict { IOSTANDARD LVCMOS18 SLEW SLOW DRIVE 2 } [get_ports {spareN[0][13]}]    ; # pllSpiCsb(3)
